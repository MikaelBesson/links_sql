...
<div class="content">
    ...
    <form action="/index.php?ctrl=edit_link&id=<?= $data->getId() ?>" method="post">
        <fieldset>
            <legend>Moddifier le lien :</legend>
            <span>Titre du lien :<?= $data->getTitle() ?> </span>
            <input id="newTitle" type="text" name="newTitle" title="Nouveaux Titre"
                   placeholder="Nouveaux titre ici"><br><br>

            <span>Href du lien :<?= $data->getHref() ?></span>
            <input id="newHref" type="text" name="newHref" title="Nouvelle Href"
                   placeholder="Nouvelle Href ici"><br><br>
            ...
            <input id="newName" type="text" name="newName" title="Nouveaux Nom du lien"
                   placeholder="Nouveaux nom ici"><br><br>
